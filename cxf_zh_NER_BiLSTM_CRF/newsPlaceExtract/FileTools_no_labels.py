...
def read_xls_data_bark(input_file):
    # 读取指定列
    df = pd.read_excel(input_file, header=0, index=0, usecols=[3, 4, 5, 6, 7, 8, 9, 12])
    # print(df.columns)
    df.columns = ['title', 'nation', 'province', 'city', 'county', 'algorithm_province', 'algorithm_city', 'text']
...
# revised by zengzenghe in 20190524，function：read 3 and 8 line of “xls” file  ---begin---
def read_xls_data(input_file):
    # 读取指定列
    # revised by  zengzenghe in 20190524 ---begin---
    df = pd.read_excel(input_file, header=0, index=0, usecols=[3, 8])
    # print(df.columns)
    df.columns = ['title', 'text']
    # revised by  zengzenghe in 20190524 ---end---
    ...
    return df
# revised by zengzenghe in 20190524，function：read 3 and 8 line of “xls” file  ---end---
