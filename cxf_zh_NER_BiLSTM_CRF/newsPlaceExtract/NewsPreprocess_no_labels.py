...
from cxf_zh_NER_BiLSTM_CRF.newsPlaceExtract import NewsConst
...
def merge_result():
    # input_file = 'data/news_clean.xls'
    input_file = 'data/News_weibo_20190523.xls'
    output_file = 'input/News_weibo_merge.txt'
    ...
    # 去掉 留言信息等非新闻文本
    clean = [981, 982, 984, 985, 986, 987, 988, 989, 990, 992, 993, 994, 995, 936, 938, 797, 798, 799, 800, 801, 802,
             803, 106, 108, 109, 110, 121, 126, 142, 143, 149, 151, 159, 177, 182, 190, 191, 196, 198, 201, 206, 212,
             250, 255, 262, 269, 293, 295, 300, 302, 305, 308, 337, 340, 352, 362, 368, 375, 391, 399, 402, 403, 405,
             416, 470, 471, 479, 487, 505]
    ...
    for index, row in df.iterrows():
        ...
        # comment by zengzenghe in 20190524 ---begin---
        ...
        #     row['county'] = 'null'
        # comment by zengzenghe in 20190524 ---end---
...
def main():
    ...
    # revised by zengzenghe in 20190527，function：count character numbers of “xls” file  ---begin---

    # one_new_number = 0
    # one_xls_number = 0
    # many_xls_number = 0
    # addresslist = []
    # add1 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_app1_20190523.xls'
    # addresslist.append(add1)
    # add2 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_app2_20190523.xls'
    # addresslist.append(add2)
    # add3 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_epaper1_20190523.xls'
    # addresslist.append(add3)
    # add4 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_epaper2_20190523.xls'
    # addresslist.append(add4)
    # add5 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_epaper3_20190523.xls'
    # addresslist.append(add5)
    # add6 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_news1_20190523.xls'
    # addresslist.append(add6)
    # add7 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_news2_20190523.xls'
    # addresslist.append(add7)
    # add8 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_news3_20190523.xls'
    # addresslist.append(add8)
    # add9 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_wechat_20190523.xls'
    # addresslist.append(add9)
    # add10 = r'D:\PycharmProjects\cxf_zh_NER_BiLSTM_CRF\newsPlaceExtract\data\News_weibo_20190523.xls'
    # addresslist.append(add10)
    # for add in addresslist:
    #     df = FileTools.read_xls_data(add)
    #     for index, row in df.iterrows():
    #         for content in row['src_text']:
    #             one_new_number += len(content)
    #         one_xls_number += one_new_number
    #         one_new_number = 0
    #     print(add + ' has ' + str(index) + ' item and has ' + str(one_xls_number) + 'number')
    #     many_xls_number += one_xls_number
    #     one_xls_number = 0
    # print("\n所有字符数目：", many_xls_number)
    # revised by zengzenghe in 20190527，function：count character numbers of “xls” file  ---end---
